			  ...
			  <table class="table" data-responsive="table" id="resultTable">
				...
				for($i=0; $row = $query->fetch(); $i++){
					...
					<tr>
						...
						<td>$<?php echo number_format($aporta, 2); ?></td>							
						<td>$ <?php
...
$totl=$apo+$gas;
 ...
 <div class="resdiv">
			  <div class="represult">
			  		<div class="resultmod">
			  			<div class="resultline">Gastos:</div>
			  			<div class="resultline">$<?php echo number_format($gas, 2);?></div>
			  		</div>
			  		<div class="resultmod">
			  			<div class="resultline">Reposición:</div>
			  			<div class="resultline"><input id="reps" class="nputs w100per bordergray"></div>
			  		</div>
			  		<div class="resultmod">
			  			<div class="resultline totsave" onclick="oper('<?php echo $gas;?>', <?php echo $idr;?>)">Total:</div>
			  			<div class="resultline"><input class="nputs w100per bordergray" id="resoper" readonly></div>
			  		</div>
			  </div>
 </div>
<a href="reportes/reporte_conceptos.php?q1=<?php echo $q1;?>&q2=<?php echo $q2;?>&idr=<?php echo $idr;?>"><div class="nputsave">Generar</div></a>
</div>			
	</div>
