...
async function showsinve(uid, pid){
      $.ajax({
         type: "POST",
         url: './ajax/buscar_sinve.php',
...
/* detalles */
async function sinvedetalles(idr, uid){
      $.ajax({
      type: "POST",
      url: './ajax/hist_sinve.php',
...
$('#res_ids').val("");
   ...
   async function trat_disp(idr, fec, hou){
