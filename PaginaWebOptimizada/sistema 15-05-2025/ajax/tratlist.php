...
<div class="gralshort">
  ...
  <tr>
    <td>Nombre</td>
    <td><input class="nputs" type="text" name="nombre" value="<?php echo $nombre; ?>" readonly></td>
    <td>N.S.S.</td>
    <td><input class="nputs w120" type="text" name="nss" value="<?php echo $nss; ?>" readonly></td>
    <td>E. civil</td>
  ...
  <tr>
    ...
    <td>Edad</td>
    <td><input class="nputs w110" type="text" name="age" name="edad_residente" value="<?php echo $edad; ?>" readonly></td>
  </tr>
  <tr>
    <td></td>
    <td></td>
