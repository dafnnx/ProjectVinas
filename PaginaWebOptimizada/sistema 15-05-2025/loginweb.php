      ...
      <div class="user signinBx">
        ...
        <div class="formBx">
          <form method="post" accept-charset="utf-8" action="login.php" name="loginform" autocomplete="off" role="form" >
            ...
            <input placeholder="Usuario" name="user_name" type="text" required>
            <input placeholder="Contraseña" name="user_password" type="password" placeholder="Password" autocomplete="off" required>
