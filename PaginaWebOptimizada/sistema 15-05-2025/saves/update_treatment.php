...
require_once ("../cn/connect2.php");
	...
	if(isset($_POST["daysed"]))
		{	$ga=implode(",",$_POST["daysed"]);  }
	...
	$ta= "0";
	$ua= "1";
	$va= $_POST['consul_tratamientoed'];
$sql2 = "UPDATE tratamientos SET fecha_ini='$ba', fecha_fin='$ca', med_tratamiento='$da', via_medicamento='$ea', unidad_medicamento='$fa', semana_tratamiento='$ga', variante_tratamiento='$ha', total_tratamiento='$ia', dia_tratamiento='$ja', siet_tratamiento='$ka', och_tratamiento='$la', trce_tratamiento='$ma', dieco_tratamiento='$na', vtuno_tratamiento='$oa', observa_tratamiento='$pa', patolo_tratamiento='$qa', tipom_tratamiento='$ra', pauta_tratamiento='$sa', user_id='$ta', status_tratamiento='$ua', consul_tratamiento='$va' WHERE id_tratamiento=$aa";
