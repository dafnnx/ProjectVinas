<div class="gralmain">  
      <div class="paycnt">
        <div class="btnmain2 pointer" onclick="mainshow('gral2', loadcontact('<?php echo $rid ?>'))">CONTACTOS</div>
        <div class="btnmain2 pointer" onclick="mainshow('gral3', ens_list('<?php echo $rid ?>'))">ENSERES</div>
        <div class="btnmain2 pointer" onclick="mainshow('gral4', loadinv('<?php echo $rid ?>'))">MEDICAMENTOS</div>
      </div>
  </div>
    <div class="gralfull">
    <div class="gralmid" id="gral2">
 <form id="selcont" method="POST">
<table class="infotab"> 
  <input type="hidden" name="saved_idrcont" id="saved_idrcont">  
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input type="checkbox" name="fav_contacto" autocomplete="off" value="1">Favorito</td>
    <td>
      <input type="submit" class="nputsave" id="savecont" value="Añadir">
    </td>  
  </tr>
</table>
</form>
