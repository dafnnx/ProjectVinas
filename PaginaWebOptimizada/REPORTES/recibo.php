...
$infopay= loadpay($idpa);
    foreach ($infopay as $infopayy):
endforeach;
$fecha= $infopayy['fecha_pay'];
...
$mihtml .= '<div style="width: 100%;  height: 20px;  text-align: center;  padding: 2px 0px;">'.$infopayy['id_pay'].'</div>'; 
...
$mihtml .= '</div>';
$mihtml .= '<div style="width: 95%;   height: 20px;  padding-top: 10px;  padding-bottom: 10px;  margin: 0 auto;">';
$mihtml .= '<div style="width: 17%;  height: 20px;  display: inline-block;">  Entrega:</div> <div style="width: 82%;  height: 20px;  display: inline-block;  border-bottom: 1px solid gray;">'.$infopayy['persona_pay'].'</div>';
$mihtml .= '</div>';
$mihtml .= '<div style="width: 95%;   height: 20px;  padding-top: 10px;  padding-bottom: 10px;  margin: 0 auto;">';
$mihtml .= '<div style="width: 17%;  height: 20px;  display: inline-block;">  Concepto:</div> <div style="width: 82%;  height: 20px;  display: inline-block; border-bottom: 1px solid gray;">'.$infopayy['concept_pay'].'</div>';
$mihtml .= '</div>';
$mihtml .= '<div style="width: 95%;   height: 20px;  padding-top: 10px;  padding-bottom: 10px;  margin: 0 auto;">';
$mihtml .= '<div style="width: 17%;  height: 20px;  display: inline-block;">  Cantidad:</div> <div style="width: 82%;  height: 20px;  display: inline-block; border-bottom: 1px solid gray;">$ '.$infopayy['aporta_pay'].' Pesos M.N.</div>';
$mihtml .= '</div>';
$mihtml .= '<div style="width: 95%;   height: 20px;  padding-top: 10px;  padding-bottom: 10px;  margin: 0 auto;">';
$mihtml .= '<div style="width: 17%;  height: 20px;  display: inline-block;">  Forma de pago:</div> <div style="width: 82%;  height: 20px;  display: inline-block;  border-bottom: 1px solid gray;">'.$infopayy['fpago_pay'].'</div>';
$mihtml .= '</div>';
...
$dompdf->render();
$pdf = $dompdf->output();
file_put_contents(''.$infopayy['id_pay'].'.pdf', $pdf);  
if ($pdf) {  echo "1"; }
?>