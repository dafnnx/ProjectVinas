...
<select class="nputs w80per brd" id="status_ropastatus" name="status_ropastatus">
          <option disabled selected>Selecciona status</option>
          <option value="activo">Activo</option>
          <option value="baja">Baja</option>
</select>  
            <input type="date" id="fecha_ropastatus" name="fecha_ropastatus" class="nputs brd" placeholder="Fecha">
      </div>
      <div class="w100per dpflex">
            <input type="text" id="motivo_ropastatus" name="motivo_ropastatus" class="nputs w50per brd" placeholder="Motivo">
            <input type="text" id="persona_ropastatus" name="persona_ropastatus" class="nputs w50per brd" placeholder="Persona">
      </div>
            </div>            
...
<div class="nback" onclick="back('<?php echo $ida; ?>', '<?php echo $rid; ?>');">atras</div>
</div>