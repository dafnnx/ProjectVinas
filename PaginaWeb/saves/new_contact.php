...
require_once ("../cn/connect2.php");
	...
	$na= $_POST['user_id'];
$sql2 = "INSERT INTO contactos (id_residente, alta_contacto, nombre_contacto, parent_contacto, fnac_contacto, edad_contacto, dir_contacto, mpo_contacto, cp_contacto, tela_contacto, telb_contacto, telc_contacto, mail_contacto, user_id) VALUES (:a, :b, :c, :d, :e, :f, :g, :h, :i, :j, :k, :l, :m, :n)";
