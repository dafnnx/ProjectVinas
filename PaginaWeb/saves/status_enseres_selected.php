...
$sta = 'baja'; // Status fijo para dar de baja enseres
$mot = $_POST['motivo'];
$per = $_POST['persona'];
...
if ($check_result['count'] > 0) {
    ...
    if ($svb) {
        ...
        // Crear el script JavaScript para Sweet Alert y refresh
        echo '<script>
            Swal.fire({
                icon: "success",
                title: "¡Correcto!",
                text: "Los enseres seleccionados se han dado de baja correctamente",
    ...
    echo '<script>
        Swal.fire({
            icon: "warning",
            title: "Sin enseres",
            text: "Los enseres seleccionados no pertenecen al residente o no existen",
            confirmButtonText: "OK"
        });
    </script>';
}
