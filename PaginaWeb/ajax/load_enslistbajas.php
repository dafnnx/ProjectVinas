...
$rid =$_POST['rid']; 
	...
	if($action == 'ajax'){
         $q =$_POST['q'];
		 $aColumns = array('marca_ropa', 'nombre_ropa', 'talla_ropa');
			...
			<input type="hidden" value="<?php echo $rid; ?>" id="tgtrid">
			  <table class="table" data-responsive="table" id="resultTable">
				...
				for($i=0; $row = $query->fetch(); $i++){
					...
					<tr>
					<td>
					  <input type="checkbox" class="thecheckgraltbajas" value="<?php echo $idr; ?>" id="boxgralbajas-<?php echo $idr; ?>">
					  <label for="boxgralbajas-<?php echo $idr; ?>" class="mleft5"></label>
					</td>
...
<?php	} else {		echo "Sin enseres Bajas";   	} }	 ?>
<script type="text/javascript" src="./js/checkbox.js"></script>
<script type="text/javascript" src="./js/checkens.js"></script>
<script type="text/javascript" src="./js/enslistbajas.js"></script>