...
<div class="indind bgtbl tblline">
        <div class="indxm speciline"><?php echo $j++; ?></div>
        <div class="indxmain">
...
<?php } ?>
        ...
        <div class="speci1dat speciline"><?php echo $varit; ?></div>
...
<div class="tblspecialdat">
        <div class="speci4dat speciline"><?php echo $observa; ?></div>
...
<?php  
    ...
    $cy2->execute();
    for($i=0; $row = $cy2->fetch(); $i++){              $nvia = $row['nvia']; ?>
...
<?php }  
    ...
    $cy3->execute();
    for($i=0; $row = $cy3->fetch(); $i++){                      $nuni = $row['nuni']; ?>
...
<?php } ?>
<div class="nputsave">Actualizar</div>
</div>