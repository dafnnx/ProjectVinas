  ...
  <input type="hidden" name="resic_inv" id="resic_inv" value="<?php echo $rid; ?>">
<div class="miniseparator"></div>
            <div class="fixer">
  <input type="text" class="nputs w100per padd5" id="qm" onkeyup='loadmeds();' placeholder="Buscar Medicamento" autocomplete="off">
            </div>
<div class="miniseparator"></div>
            <div class="fixer">
...
<div class="invnfo ">
  ...
  <div class="subinv13">
    <input type="submit" class="nputsave" value="Guardar" onclick="newinvent(<?php echo $rid ?>);">
  </div>
</div>   
</div>  
    <div class="ldcntup">
